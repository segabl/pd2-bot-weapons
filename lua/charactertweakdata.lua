...
function CharacterTweakData:_presets(...)
  ...
  BotWeapons:set_accuracy_multiplicator(presets.weapon.gang_member.m14, 1)
  ...
  BotWeapons:set_accuracy_multiplicator(presets.weapon.gang_member.lmg, 0.7)
  ...
  BotWeapons:set_damage_multiplicator(presets.weapon.gang_member.r870, m4_dmg_mul * 0.7)
  BotWeapons:set_accuracy_multiplicator(presets.weapon.gang_member.r870, 1)
  ...
  presets.weapon.gang_member.mossberg.RELOAD_SPEED = presets.weapon.gang_member.r870.RELOAD_SPEED * 0.8
  BotWeapons:set_damage_multiplicator(presets.weapon.gang_member.mossberg, m4_dmg_mul * 0.8)
  ...
  -- snipers
  presets.weapon.gang_member.rifle = deep_clone(presets.weapon.gang_member.beretta92)
  presets.weapon.gang_member.rifle.range = { close = 5000, optimal = 10000, far = 15000 }
  presets.weapon.gang_member.rifle.RELOAD_SPEED = 0.4
  presets.weapon.gang_member.rifle.spread = m4_spread * 0.25
  BotWeapons:set_damage_multiplicator(presets.weapon.gang_member.rifle, m4_dmg_mul * 4)
  BotWeapons:set_accuracy_multiplicator(presets.weapon.gang_member.rifle, 3)
  BotWeapons:set_single_fire_mode(presets.weapon.gang_member.rifle, {{2, 3}, {3, 4}, {4, 5}})

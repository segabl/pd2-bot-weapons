...
function CharacterTweakData:_presets(...)
  ...
  BotWeapons:set_auto_fire_mode(presets.weapon.gang_member.lmg, {0, 0, 0, 1})
  ...
  BotWeapons:set_auto_fire_mode(presets.weapon.gang_member.saiga, {0, 0.33, 0.66, 1}, {0.33, 0.66, 1, 0})

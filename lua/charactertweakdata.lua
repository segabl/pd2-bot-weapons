...
function CharacterTweakData:_presets(tweak_data, ...)
	...
	local rifle_dmg_mul = difficulty_index * 0.7

	-- rifle preset
	crew_presets.is_rifle.FALLOFF = {
		{ dmg_mul = rifle_dmg_mul * 0.7, r = 0, acc = { 1, 1 }, recoil = { 1, 1 }, mode = { 0, 0, 0, 1 } },
		{ dmg_mul = rifle_dmg_mul * 0.3, r = 4000, acc = { 1, 1 }, recoil = { 1, 1 }, mode = { 0, 0, 0, 1 } }
	}
	...
	crew_presets.is_pistol.FALLOFF = {
		...
		{ dmg_mul = rifle_dmg_mul * 0.2, r = 4000, acc = { 1, 1 }, recoil = { 1, 1 }, mode = { 1, 0, 0, 0 } }
	}
